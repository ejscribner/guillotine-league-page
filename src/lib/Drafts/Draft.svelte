  ...
  <div class="accuracy">
    <div class="accuracyText">
      ...
      <span class="disclaimer"
        >(accuracy will improve as the regular season progresses)</span
      >
    </div>
        ...
        {#if draftPosition}
          <Cell class="draftTeam">
            <img
              ...
              alt="{getTeamNameFromTeamManagers(
                leagueTeamManagers,
                draftPosition,
                year
              )} avatar"
            ...
            <span
              ...
              >{getTeamNameFromTeamManagers(
                ...
                draftPosition,
                year
              )}{@html getTeamNameFromTeamManagers(
                leagueTeamManagers,
                draftPosition,
                year
              ) !=
              getTeamNameFromTeamManagers(leagueTeamManagers, draftPosition)
                ? `<br /><span class="curDraftName">(${getTeamNameFromTeamManagers(
                    leagueTeamManagers,
                    draftPosition
                  )})</span>`
                : ""}</span
