  ...
  const setTransactionsAndGraphs = (wD) => {
    ...
    for (const w of wD) {
      ...
      if (tradesData[0].managerID) {
        trades =
          tradesData.find((t) => t.managerID == w.managerID)?.trades || 0;
        ...
        {#each weekRecords as leagueWeekRecord, ix}
          <Row>
            ...
            <Cell
              ...
              on:click={() =>
                gotoManager({
                  year: leagueWeekRecord.year || prefix,
                  leagueTeamManagers,
            ...
            <Cell
              >{allTime ? leagueWeekRecord.year + " " : ""}{key ==
              "regularSeasonData"
                ? "Week "
                : ""}{leagueWeekRecord.week}</Cell
            >
    ...
    <DataTable class="recordTable">
      <Head>
        <Row>
          <Cell class="header headerPrimary" colspan="4"
            >{prefix}
            {key == "playoffData" ? "Playoff " : ""}Single Week Scoring Lows</Cell
          >
        </Row>
        <Row>
          <Cell class="header rank" />
        ...
        {#each weekLows as leagueWeekLow, ix}
          <Row>
            ...
            <Cell
              ...
              on:click={() =>
                gotoManager({
                  year: leagueWeekLow.year || prefix,
                  leagueTeamManagers,
            ...
            <Cell
              >{allTime ? leagueWeekLow.year + " " : ""}{key ==
              "regularSeasonData"
                ? "Week "
                : ""}{leagueWeekLow.week}</Cell
            >
      ...
      <Head>
        <Row>
          <Cell class="header headerPrimary" colspan="5"
            >All-Time Highest Season Points<span class="italic"
              >Ranked by PPG</span
            ></Cell
          >
        </Row>
  ...
  {#if allTime && key == "regularSeasonData"}
    <DataTable class="recordTable">
      <Head>
        <Row>
          <Cell class="header headerPrimary" colspan="5"
            >All-Time Lowest Season Points<span class="italic"
              >Ranked by PPG</span
            ></Cell
          >
        </Row>
  ...
  {#if blowouts && blowouts.length}
    <DataTable class="recordTable">
      <Head>
        <Row>
          <Cell class="header headerPrimary" colspan="4"
            >{prefix} Largest {key == "playoffData"
              ? "Playoff "
              : ""}Blowouts</Cell
          >
        </Row>
      ...
      <Body>
        {#each blowouts as blowout, ix}
          <Row>
            ...
            <Cell
              >{allTime ? blowout.year + " " : ""}{key == "regularSeasonData"
                ? "Week "
                : ""}{blowout.week}</Cell
            >
  ...
  {#if closestMatchups && closestMatchups.length}
    <DataTable class="recordTable">
      <Head>
        <Row>
          <Cell class="header headerPrimary" colspan="4"
            >{prefix} Narrowest {key == "playoffData"
              ? "Playoff "
              : ""}Wins</Cell
          >
        </Row>
      ...
      <Body>
        {#each closestMatchups as closestMatchup, ix}
          <Row>
            ...
            <Cell class="cellName differentialName">
              <div class="vsRecord">
                <div
                  on:click={() =>
                    gotoManager({
                      year: closestMatchup.year || prefix,
                      leagueTeamManagers,
            ...
            <Cell
              >{allTime ? closestMatchup.year + " " : ""}{key ==
              "regularSeasonData"
                ? "Week "
                : ""}{closestMatchup.week}</Cell
            >
        ...
        <DataTable class="rankingTable">
          <Head>
            <Row>
              <Cell class="header headerPrimary" colspan="5">
                {prefix}
                {key == "playoffData" ? "Playoff " : ""}Lineup IQ Rankings
                <div class="subTitle">
        ...
        <Head>
          <Row>
            <Cell class="header headerPrimary" colspan="6"
              >{prefix}
              {key == "playoffData" ? "Playoff " : ""}Win Percentages Rankings</Cell
            >
          </Row>
          <Row>
            <Cell class="header" />
          ...
          {#each winPercentages as winPercentage, ix}
            <Row>
              ...
              <Cell
                ...
                on:click={() =>
                  gotoManager({
                    year: winPercentage.year || prefix,
                    leagueTeamManagers,
      ...
      <DataTable class="rankingTable">
        <Head>
          <Row>
            <Cell class="header headerPrimary" colspan="5">
              {prefix}
              {key == "playoffData" ? "Playoff " : ""}Fantasy Points Rankings
            </Cell>
          </Row>
          <Row>
            <Cell class="header" />
