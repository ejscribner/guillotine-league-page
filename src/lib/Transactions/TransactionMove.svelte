      ...
      <div class="cellParent">
        ...
        {#if cell && cell.player}
          <div class="playerSlot">
            <div
              class="tradeSlot playerAvatar"
              style="border-color: var(--{players[cell.player]
                .pos}); {getAvatar(players[cell.player].pos, cell.player)}"
            >
              <i class="indicator material-icons" aria-hidden="true"
                >add_circle</i
              >
            </div>
            <div class="nameHolder">
              <span class="name"
                >{`${players[cell.player].fn} ${players[cell.player].ln}`}</span
              >
          ...
          <div class="playerSlot">
            <div class="avatarHolder">
              <div class="tradeSlot pick">
                ...
                <span class="pickInfo">
                  {cell.pick.round}<span class="numEnd"
                    >{getNumEnd(cell.pick.round)}</span
                  >
                </span>
                <i class="indicator material-icons" aria-hidden="true"
                  >add_circle</i
          ...
          <div class="playerSlot">
            <div class="avatarHolder">
              <div class="tradeSlot origin">
                {#if dest - origin < 0}
                  <i class="direction material-icons" aria-hidden="true"
                    >chevron_left</i
                  >
                {:else}
                  <i class="direction material-icons" aria-hidden="true"
