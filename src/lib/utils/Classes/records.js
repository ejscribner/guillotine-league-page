...
export class Records {
   ...
   */
  constructor() {
    // constructor returns empty records block
...
Records.prototype.addAllTimeMatchupDifferentials = function (
  ...
  this.allTimeMatchupDifferentials = this.allTimeMatchupDifferentials.concat(
    matchupDifferentials
  );
};
 ...
 * @param {int} lastYear
 */
Records.prototype.finalizeAllTimeRecords = function ({
  currentYear,
  lastYear,
}) {
