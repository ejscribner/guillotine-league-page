...
<div class="awards">
  ...
  <div id="podium">
    ...
    <img
      ...
      on:click={() =>
        gotoManager({ year, leagueTeamManagers, rosterID: champion })}
      alt="champion"
    />
    ...
    <img
      ...
      on:click={() =>
        gotoManager({ year, leagueTeamManagers, rosterID: second })}
      alt="2nd"
    />
    <span
    ...
    <img
      ...
      on:click={() =>
        gotoManager({ year, leagueTeamManagers, rosterID: third })}
      alt="3rd"
    />
    <span
    ...
    <div class="toiletParent">
      ...
      <div class="toiletBowl">
        <img
          ...
          on:click={() =>
            gotoManager({ year, leagueTeamManagers, rosterID: toilet })}
